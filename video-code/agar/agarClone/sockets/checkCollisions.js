...
function checkForOrbCollisions(pData,pConfig, orbs, settings){
    return new Promise((resolve, reject)=>{
        ...
        // AABB Test(square)  - Axis-aligned bounding boxes
			...
			// resolve index, new orb that replaced old one
                    resolve(i)
                }
            }
        });
...
//testing that we don't want server to have to do. 
//can change game emchanics here
...
function updateScores(killer, killed){
    ...
    //we return who died and who killed the other one.
    return{
        died: killed,
        killedBy: killer,
    }
