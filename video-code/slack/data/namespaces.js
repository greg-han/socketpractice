...
let namespaces = [];
//make a new namespace with 0 as id, 'Wiki' as title, img, and endpoint will be /wiki
//That's what we'll tell the browser what we will connect to if we want this namespace
...
//Push all three namespaces onto the namespace array
namespaces.push(wikiNs,mozNs,linuxNs);

// Make the main room and add it to rooms. it will ALWAYS be 0
// New rooms will be pushed onto the wikiNS object
// Room id, name of room, namespace it belongs too. This is a funcgtion in the
// Namespace class has an addRoom function and aroom object will be store din namespaces
...
//Notice that this exports the namespaces object if you import this file.
